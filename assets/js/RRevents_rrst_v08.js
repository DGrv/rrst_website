        ...
        card.innerHTML = `
            <div class="EventCardColumns">
                ...
                <div class="EventCardLogo">
                    <img class="logo" src='{{ "/assets/images/logo/events/logo_${event.id}.png" | relative_url}}' alt="" onerror="if (!this.dataset.tried) { this.src='https://my.raceresult.com/${event.id}/logo'; this.dataset.tried='true'; } else { this.style.display='none'; }">
